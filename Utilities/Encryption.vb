...
#Region "  Hash"
  ...
  Public Class Hash
    ...
    Public Function Calculate(ByVal filePath As String) As Data
      Dim str As Stream = File.OpenRead(filePath)
...
#Region "  CRC32 HashAlgorithm"
    Private Class CRC32
      ...
      Private ReadOnly crcLookup() As Integer = {
...
#Region "  Symmetric"
  ...
  Public Class Symmetric
    ...
    'Private ReadOnly _data As Data
    Private _key As Data
    Private _iv As Data
    Private ReadOnly _crypto As SymmetricAlgorithm
    Private ReadOnly _EncryptedBytes As Byte()
    Private ReadOnly _UseDefaultInitializationVector As Boolean
...
#Region "  Asymmetric"
  ...
  Public Class Asymmetric
    ...
    'Private ReadOnly _UseMachineKeystore As Boolean = True
...
#End Region
    ...
    Private Function EncryptPrivate(ByVal d As Data) As Data
      ...
      Catch ex As CryptographicException
        ApplicationLogging.LogException(ex, Reflection.MethodBase.GetCurrentMethod)
        If ex.Message.ToLower.IndexOf("bad length", StringComparison.CurrentCultureIgnoreCase) > -1 Then
    ...
    Private Function GetRSAProvider() As RSACryptoServiceProvider
      Try
        Dim csp As New CspParameters With {
    .KeyContainerName = _KeyContainerName
  }
        Dim rsa As New RSACryptoServiceProvider(_KeySize, csp) With {
    .PersistKeyInCsp = False
      ...
      Catch ex As System.Security.Cryptography.CryptographicException
        ApplicationLogging.LogException(ex, Reflection.MethodBase.GetCurrentMethod)
        If ex.Message.ToLower.IndexOf("csp for this implementation could not be acquired", StringComparison.CurrentCultureIgnoreCase) > -1 Then
...
#Region "  Data"
  ...
  Public Class Data
    ...
    Private mobjBytes As Byte()
    Private mintMaxBytes As Integer = 0
    Private mintMinBytes As Integer = 0
    Private mintStepBytes As Integer = 0
    ...
    'Public Shared DefaultEncoding As Text.Encoding = System.Text.Encoding.GetEncoding("UTF-16")
    'Public Shared DefaultEncoding As Text.Encoding = CodePagesEncodingProvider.Instance.GetEncoding("Windows-1252")
...
#End If
    ...
    ''' </summary>
    Public Sub New(ByVal lpByte As Byte())
      mobjBytes = lpByte
    End Sub
    ...
    ''' </summary>
    Public Sub New(ByVal lpString As String)
      Me.Text = lpString
    End Sub
    ...
    ''' </summary>
    Public Sub New(ByVal lpString As String, ByVal lpEncoding As System.Text.Encoding)
      Me.Encoding = lpEncoding
      Me.Text = lpString
    End Sub
    ...
    Public ReadOnly Property IsEmpty() As Boolean
      Get
        If mobjBytes Is Nothing Then
          Return True
        End If
        If mobjBytes.Length = 0 Then
          Return True
        End If
        Return False
      End Get
    ...
    Public Property StepBits() As Integer
      Get
        Return mintStepBytes * 8
      End Get
      Set(ByVal Value As Integer)
        mintStepBytes = Value \ 8
      End Set
    End Property
    ...
    Public Property MinBits() As Integer
      Get
        Return mintMinBytes * 8
      End Get
      Set(ByVal Value As Integer)
        mintMinBytes = Value \ 8
      End Set
    End Property
    ...
    Public Property MaxBits() As Integer
      Get
        Return mintMaxBytes * 8
      End Get
      Set(ByVal Value As Integer)
        mintMaxBytes = Value \ 8
      End Set
    End Property
    ...
    Public Property Bytes() As Byte()
      Get
        If mintMaxBytes > 0 Then
          If mobjBytes.Length > mintMaxBytes Then
            Dim lobjFirstByteArray(mintMaxBytes - 1) As Byte
            Array.Copy(mobjBytes, lobjFirstByteArray, lobjFirstByteArray.Length)
            mobjBytes = lobjFirstByteArray
          End If
        End If
        If mintMinBytes > 0 Then
          If mobjBytes.Length < mintMinBytes Then
            Dim lobjSecondByteArray(mintMinBytes - 1) As Byte
            Array.Copy(mobjBytes, lobjSecondByteArray, mobjBytes.Length)
            mobjBytes = lobjSecondByteArray
          End If
        End If
        Return mobjBytes
      End Get
    ...
    Public Property Text() As String
      Get
        ...
        Else
          ...
          '-- first null!
          Dim i As Integer = Array.IndexOf(mobjBytes, CType(0, Byte))
          If i >= 0 Then
            'Dim lobjData As Byte() = Encoding.UTF8.GetBytes(Me.ToString)

            'Dim _Hash As New System.Security.Cryptography.SHA256Managed
            'Dim b As Byte() = _Hash.ComputeHash(lobjData)
            'mstrHash = System.Text.Encoding.UTF8.GetString(b)

            Return Me.Encoding.GetString(mobjBytes, 0, i)
          Else
            Return System.Text.Encoding.UTF8.GetString(mobjBytes)
            'Return Me.Encoding.GetString(_b)
          End If
        End If
      End Get
      Set(ByVal Value As String)
        mobjBytes = Me.Encoding.GetBytes(Value)
      End Set
    End Property
    ...
    Public Property Hex() As String
      Get
        Return Utils.ToHex(mobjBytes)
      End Get
      Set(ByVal Value As String)
        mobjBytes = Utils.FromHex(Value)
      End Set
    End Property
    ...
    Public Property Base64() As String
      Get
        Return Utils.ToBase64(mobjBytes)
      End Get
      Set(ByVal Value As String)
        mobjBytes = Utils.FromBase64(Value)
      End Set
    End Property
  ...
  Friend Class Utils
    ...
    Friend Shared Function FromHex(ByVal hexEncoded As String) As Byte()
      ...
      Catch FormatEx As FormatException
        Throw New System.FormatException(
          String.Format("The provided string does not appear to be Hex encoded: '{0}'",
            hexEncoded), FormatEx)
    ...
    Friend Shared Function FromBase64(ByVal base64Encoded As String) As Byte()
      ...
      Catch ex As System.FormatException
        ApplicationLogging.LogException(ex, Reflection.MethodBase.GetCurrentMethod)
        Throw New System.FormatException(
          String.Format("The provided string does not appear to be Base64 encoded: '{0}'",
                        base64Encoded), ex)
      End Try
    End Function
